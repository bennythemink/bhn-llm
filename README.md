# Snapshot: bhn-nolinks

Static-site snapshot of **https://www.bhn.org.au**
...
# 3. Verify
docker ps | grep snapshot_bhn-nolinks
```
...
```
bhn-nolinks.yourdomain.com {
    reverse_proxy snapshot_bhn-nolinks:80
}
```
